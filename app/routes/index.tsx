        ...
        <section className="px-2 py-10 bg-secondary lg:pt-16 lg:pb-28 md:px-6 lg:px-16">
          <div className="mx-auto max-w-7xl">
            ...
            <section className="relative hidden w-full pb-56 mx-auto mb-20 overflow-x-hidden max-w-7xl lg:block">
              ...
              <div className="absolute z-10 opacity-50 top-20 left-24 hover:opacity-100">
                <div className="left-32 top-72 orange-dot__hover"></div>
              ...
              <div className="absolute z-10 opacity-50 right-28 top-10 hover:opacity-100">
              ...
              <div className="absolute z-10 opacity-50 bottom-28 left-10 hover:opacity-100">
                <div className="left-56 bottom-48 orange-dot__hover"></div>
                <div className="w-56 p-4">
